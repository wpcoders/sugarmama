...
export default function Profile() {
	...
	const onSave = () => {
		...
		switch (currentSetting) {
			case "breakfast":
				updateProfile("alarms", { ...userProfile.alarms, breakfast: date });
				...
				break;
			case "lunch":
				updateProfile("alarms", { ...userProfile.alarms, lunch: date });
				PushNotification.getScheduledLocalNotifications((notifications) => {
					const reminder = notifications.find(
				...
				break;
			case "dinner":
				updateProfile("alarms", { ...userProfile.alarms, dinner: date });
				PushNotification.getScheduledLocalNotifications((notifications) => {
					const reminder = notifications.find(
